...
class Hospital:
 ...
 # The above code is creating a label with the text "Hospital Management System" and the font size is
        ...
        btnPrescription1 = Button(Buttonframe, text="Prescription", bg="green", fg="black", font=("arial", 12, "bold"), width=23, height=16, padx=2, pady=6)
        btnPrescription1.grid(row=0, column=0)

        btnPrescription2 = Button(Buttonframe, text="Prescription Data", bg="green", fg="white", font=("arial", 12, "bold"), width=27, height=16, padx=2, pady=2)
        btnPrescription2.grid(row=0, column=1)

        btnUpdate = Button(Buttonframe, text="Update", bg="green", fg="white", font=("arial", 12, "bold"), width=27, height=16, padx=2, pady=2)
        btnUpdate.grid(row=0, column=2)

        btnDelete = Button(Buttonframe, text="Delete", bg="green", fg="white", font=("arial", 12, "bold"), width=27, height=16, padx=2, pady=2)
        btnDelete.grid(row=0, column=3)

        btnClear = Button(Buttonframe, text="Clear", bg="green", fg="white", font=("arial", 12, "bold"), width=27, height=16, padx=2, pady=2)
        btnClear.grid(row=0, column=4)

        btnExit = Button(Buttonframe, text="Exit", bg="green", fg="white", font=("arial", 12, "bold"), width=27, height=16, padx=2, pady=2)
